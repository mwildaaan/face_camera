...
class SmartFaceCamera extends StatefulWidget {
  ...
  final void Function()? onLoadCapture;
  ...
  const SmartFaceCamera({this.imageResolution = ImageResolution.medium,
...
class _SmartFaceCameraState extends State<SmartFaceCamera>
  ...
  Widget build(BuildContext context) {
    final size = widget.size ?? MediaQuery
        .of(context)
        .size;
    final CameraController? cameraController = _controller;
    return Stack(
      ...
      children: [
        if (cameraController != null &&
          ...
          if(widget.errorBuilder != null) widget.errorBuilder!.call(context, "is Not Initialized") else
            ...[
  ...
  void _onTakePictureButtonPressed() async {
    final CameraController? cameraController = _controller;
    if (widget.onLoadCapture != null) {
      widget.onLoadCapture!();
    }
    try {
